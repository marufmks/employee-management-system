...
class EMPLMASY_Database {
    ...
    private function __construct() {
        global $wpdb;
        $this->wpdb = $wpdb;
        $this->employees_table = $wpdb->prefix . 'emplmasy_employees';
    }
    ...
    public function create_tables() {
        ...
        // Employees table
        $sql = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}emplmasy_employees (
        ...
        // Sales table
        $sql = "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}emplmasy_employee_sales (
