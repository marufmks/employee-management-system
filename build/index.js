...
const Dashboard = () => {
  const [stats, setStats] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)({
    totalEmployees: 0,
    departments: {}
  });
  ...
  }, department.charAt(0).toUpperCase() + department.slice(1)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
...
const Employees = () => {
  const [employees, setEmployees] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
  const [isModalOpen, setIsModalOpen] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [error, setError] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)('');
  const [newEmployee, setNewEmployee] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)({
    firstName: '',
    lastName: '',
    email: '',
    department: '',
  ...
  const [isEditModalOpen, setIsEditModalOpen] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  const [employeeToEdit, setEmployeeToEdit] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    fetchEmployees();
  }, []);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: department => setNewEmployee({
      ...newEmployee,
      department
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    ...
    onChange: department => setEmployeeToEdit({
      ...employeeToEdit,
      department
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
...
const Sales = () => {
  ...
  const handleDownloadCSV = async employeeId => {
    try {
      ...
      // Create CSV content
      const csvContent = 'data:text/csv;charset=utf-8,' + 'Date,Amount,Description\n' + response.map(row => `${row.date},${row.amount},"${row.description}"`).join('\n');
...
const Settings = () => {
  ...
  const [originalSettings, setOriginalSettings] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)({
    dateFormat: 'Y-m-d',
    emailNotifications: 'yes'
  });
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: dateFormat => setSettings({
      ...settings,
      dateFormat
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
...
/***/ "./src/components/frontend/Dashboard/index.js":
/*!****************************************************!*\
  !*** ./src/components/frontend/Dashboard/index.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const EmployeeDashboard = () => {
  ...
  }, userData.salesTrend > 0 ? '↑' : '↓', " ", Math.abs(userData.salesTrend), "%")))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Card, {
    className: "stat-card"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CardBody, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "stat-content"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony import */ var _components_frontend_Dashboard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/frontend/Dashboard */ "./src/components/frontend/Dashboard/index.js");
...
if (adminRoot) {
  ...
  root.render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_admin_App__WEBPACK_IMPORTED_MODULE_2__["default"], null));
}
...
if (employeeRoot) {
  ...
  root.render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_frontend_Dashboard__WEBPACK_IMPORTED_MODULE_3__["default"], null));
}
})();
